...
class RANGEWISE extends StatelessWidget {
  RANGEWISE({
    Key key,
  }) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          Pinned.fromSize(
            bounds: Rect.fromLTWH(0.0, 292.0, 360.0, 68.0),
          ...
          Pinned.fromSize(
            ...
            child: Stack(
              children: <Widget>[
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(116.0, 22.0, 128.0, 16.0),
                  size: Size(360.0, 60.0),
                  fixedWidth: true,
                  fixedHeight: true,
                  child: Text(
                  ...
                  child: PageLink(
                    ...
                    child: Stack(
                      children: <Widget>[
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(52.4, 10.2, 62.0, 15.0),
                          size: Size(161.0, 36.0),
                          fixedWidth: true,
                          fixedHeight: true,
                          child: Text(
                  ...
                  child: PageLink(
                    ...
                    child: Stack(
                      children: <Widget>[
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(53.4, 10.2, 60.0, 15.0),
                          size: Size(161.0, 36.0),
                          fixedWidth: true,
                          fixedHeight: true,
                          child: Text(
          ...
          Pinned.fromSize(
            ...
            child: Stack(
              children: <Widget>[
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(58.0, 15.0, 124.0, 15.0),
                  size: Size(240.0, 162.0),
                  pinTop: true,
                  fixedWidth: true,
                  fixedHeight: true,
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(105.0, 57.0, 50.0, 15.0),
                  size: Size(240.0, 162.0),
                  fixedWidth: true,
                  fixedHeight: true,
                  child: Text(
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(105.0, 94.0, 57.0, 15.0),
                  size: Size(240.0, 162.0),
                  fixedWidth: true,
                  fixedHeight: true,
                  child: Text(
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(105.0, 131.0, 50.0, 15.0),
                  size: Size(240.0, 162.0),
                  pinBottom: true,
                  fixedWidth: true,
                  fixedHeight: true,
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(24.0, 311.0, 146.0, 30.0),
            size: Size(360.0, 760.0),
            pinLeft: true,
            fixedWidth: true,
            fixedHeight: true,
            child: Stack(
              children: <Widget>[
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(10.0, 7.0, 52.0, 15.0),
                  size: Size(146.0, 30.0),
                  pinLeft: true,
                  fixedWidth: true,
                  fixedHeight: true,
                  child: Text(
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(0.0, 0.0, 146.0, 30.0),
                  size: Size(146.0, 30.0),
                  pinLeft: true,
                  pinRight: true,
                  pinTop: true,
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(190.0, 311.0, 146.0, 30.0),
            size: Size(360.0, 760.0),
            pinRight: true,
            fixedWidth: true,
            fixedHeight: true,
