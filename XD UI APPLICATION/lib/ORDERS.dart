    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(0.0, 143.0, 360.5, 203.0),
            size: Size(360.0, 760.0),
            pinLeft: true,
            child:
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(0.0, 353.0, 360.5, 203.0),
            size: Size(360.0, 760.0),
            pinLeft: true,
            child:
                // Adobe XD layer: 'Paid Order' (group)
