...
class UPDATESTOCKVALUES extends StatelessWidget {
  UPDATESTOCKVALUES({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          Pinned.fromSize(
            ...
            child: Stack(
              children: <Widget>[
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(287.0, 21.0, 54.8, 15.3),
                  size: Size(360.0, 60.0),
                  pinRight: true,
                  fixedWidth: true,
                  fixedHeight: true,
                  child:
                    ...
                    children: <Widget>[
                      Pinned.fromSize(
                        bounds: Rect.fromLTWH(29.2, 1.7, 25.6, 13.5),
                        size: Size(54.8, 15.3),
                        pinRight: true,
                        pinTop: true,
                        pinBottom: true,
                      ...
                      Pinned.fromSize(
                        bounds: Rect.fromLTWH(0.0, 0.0, 30.0, 15.0),
                        size: Size(54.8, 15.3),
                        pinLeft: true,
                        pinTop: true,
                        pinBottom: true,
          ...
          Pinned.fromSize(
            ...
            child: Stack(
              children: <Widget>[
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(20.0, 48.0, 58.0, 15.0),
                  size: Size(360.5, 318.0),
                  pinLeft: true,
                  pinTop: true,
                  fixedWidth: true,
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(110.0, 48.0, 48.0, 15.0),
                  size: Size(360.5, 318.0),
                  pinTop: true,
                  fixedWidth: true,
                  fixedHeight: true,
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(177.0, 48.0, 42.0, 15.0),
                  size: Size(360.5, 318.0),
                  pinTop: true,
                  fixedWidth: true,
                  fixedHeight: true,
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(239.0, 48.0, 42.0, 15.0),
                  size: Size(360.5, 318.0),
                  pinTop: true,
                  fixedWidth: true,
                  fixedHeight: true,
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(309.0, 168.0, 36.0, 15.0),
                  size: Size(360.5, 318.0),
                  pinRight: true,
                  fixedWidth: true,
                  fixedHeight: true,
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(100.0, 8.0, 68.0, 15.0),
                  size: Size(360.5, 318.0),
                  pinTop: true,
                  fixedWidth: true,
                  fixedHeight: true,
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(300.0, 8.0, 54.0, 15.0),
                  size: Size(360.5, 318.0),
                  pinRight: true,
                  pinTop: true,
                  fixedWidth: true,
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(-2.0, 0.0, 362.0, 767.0),
            size: Size(360.0, 760.0),
            pinLeft: true,
            pinRight: true,
            pinTop: true,
                      ...
                      Pinned.fromSize(
                        ...
                        child: Stack(
                          children: <Widget>[
                            ...
                            Pinned.fromSize(
                              bounds: Rect.fromLTWH(103.0, 21.0, 82.0, 21.0),
                              size: Size(288.0, 222.5),
                              pinTop: true,
                              fixedWidth: true,
                              fixedHeight: true,
                            ...
                            Pinned.fromSize(
                              ...
                              child: Stack(
                                children: <Widget>[
                                  Pinned.fromSize(
                                    bounds:
                                        Rect.fromLTWH(0.0, 0.0, 120.0, 19.0),
                            ...
                            Pinned.fromSize(
                              ...
                              child: Stack(
                                children: <Widget>[
                                  Pinned.fromSize(
                                    bounds:
                                        Rect.fromLTWH(0.0, 0.0, 100.0, 19.0),
                                    size: Size(243.5, 48.5),
                                    pinLeft: true,
                                    pinTop: true,
                                    fixedWidth: true,
                        ...
                        child: PageLink(
                          ...
                          child: Stack(
                            children: <Widget>[
                              ...
                              Pinned.fromSize(
                                bounds: Rect.fromLTWH(22.9, 9.9, 78.0, 15.0),
                                size: Size(119.0, 36.0),
                                fixedWidth: true,
                                fixedHeight: true,
                                child: Text(
